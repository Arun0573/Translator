...
from tkinter import filedialog #for browsing the file in file explorer
from langdetect import detect #to automatically detect the language 
...
#image_label=Label(root,iage=arrow_image,width=150)
